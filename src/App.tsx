        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <span className="text-2xl font-bold text-team-blue">Excalibur</span>
                                <span className="text-team-gold font-semibold ml-2">#6738</span>
                            </div>
                        </div>
            ...
            <div className="relative bg-team-blue overflow-hidden">
                <div className="absolute inset-0">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-team-blue via-team-blue to-blue-900 opacity-90"></div>
                    <div
                        className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?ixlib=rb-1.2.1&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center mix-blend-overlay"></div>
                </div>
                    ...
                    <div className="container mx-auto px-4 py-32">
                        <div className="max-w-4xl">
                            ...
                            <div className="flex space-x-4">
                                <button
                                    className="bg-team-gold text-team-blue px-8 py-4 rounded-lg font-semibold hover:bg-opacity-90 transition flex items-center">
                                    Join Our Team <ChevronRight className="ml-2 h-5 w-5"/>
                                </button>
                                <button
                                    className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-team-blue transition">
                                    Learn More
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-16">
                        <div className="md:w-1/2">
                            ...
                            <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                                ...
                                Our robot features advanced autonomous capabilities, precise coral and alage scoring
                                mechanisms,
                      ...
                      <div className="md:w-1/2 p-8 shadow-lg custom-background"><img
                            src="/IMG_0318.JPG"
                            alt="Current Robot"
                            className="rounded-lg w-full h-80 object-cover custom-border"
                        />
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-xl border border-gray-100">
                            ...
                            <p className="text-gray-600">2025 Season District Chapionship Achievement</p>
                        </div>
                        <div className="bg-white p-8 rounded-xl border border-gray-100">
                            <div
                                className="bg-team-blue/10 rounded-full p-4 w-16 h-16 mb-6 flex items-center justify-center">

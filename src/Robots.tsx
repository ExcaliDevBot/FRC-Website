...
import { Cpu, Zap, Gauge, Trophy, ArrowRight, Shield, PenTool as Tool, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[70vh] bg-team-blue overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[url('/images/hero-bg.jpg')] bg-cover bg-fixed bg-center mix-blend-overlay"></div>
        </div>

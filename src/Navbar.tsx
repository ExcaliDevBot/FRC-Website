...
const Navbar: React.FC = () => {
    ...
    return (
        <motion.nav
            className="fixed top-0 left-0 w-full bg-white/10 backdrop-blur-lg border border-white/10 shadow-lg z-50 mix-blend-difference"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <div className="hidden md:flex space-x-8 items-center text-white">
                    <Link to="/about" className="hover:text-team-blue transition">
                        About
                    </Link>
                    <Link to="/team" className="hover:text-team-blue transition">
                        Team
                    </Link>
                    <Link to="/robots" className="hover:text-team-blue transition">
                        Robots
                    </Link>
                    <Link to="/resources" className="hover:text-team-blue transition">
                        Resources
                    </Link>
                    <Link
                        to="/sponsor-us"

            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                    ...
                    <div className="flex space-x-4">
                        <a href="mailto:ExcaliburFRC@gmail.com" target="_blank" rel="noopener noreferrer"
                           className="text-gray-400 hover:text-white transition transform hover:scale-110">
                            <Mail className="h-6 w-6"/>
                        </a>

                        <a href="https://www.youtube.com/@ExcaliburFRC" target="_blank" rel="noopener noreferrer"
                           className="text-gray-400 hover:text-white transition transform hover:scale-110">
                            <Youtube className="h-6 w-6"/>
                        </a>
                        <a href="https://github.com/ExcaliburFRC" target="_blank" rel="noopener noreferrer"
                           className="text-gray-400 hover:text-white transition transform hover:scale-110">
                            <Github className="h-6 w-6"/>
                        </a>

                        <a href="https://www.instagram.com/excalibur_6738/" target="_blank" rel="noopener noreferrer"
                           className="text-gray-400 hover:text-white transition transform hover:scale-110">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-400"><a href="mailto:ExcaliburFRC@gmail.com">ExcaliburFRC@gmail.com</a>
                        </p>
